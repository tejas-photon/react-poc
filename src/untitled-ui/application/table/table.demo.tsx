...
import { PaginationCardMinimal, PaginationPageMinimalCenter } from "../pagination/pagination";
import customers from "../table/customers.json";
import invoices from "../table/invoices.json";
import { Table, TableCard, TableRowActionsDropdown } from "../table/table";
import teamMembers from "../table/team-members.json";
import uploadedFiles from "../table/uploaded-files.json";
import { Avatar } from "../../base/avatar/avatar";
import type { BadgeTypes } from "../..//base/badges/badge-types";
import { Badge, type BadgeColor, BadgeWithDot, BadgeWithIcon } from "../..//base/badges/badges";
